...
<input type="button" value="停止！" id="stopme" style="display:none;"  \
onclick= "clearTimeout(t1); "/>  ')
function doit() {
	...
	$("#answerme").attr("style", "display:none;");
	$("#stopme").attr("style", "display:block;");
